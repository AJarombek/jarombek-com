...
const titleImageLink = shallow(<TitleImage src="./assets/github.png" title="Test" link="jarombek.com" />);
...
const pictureButton = shallow(
  <PictureButton activeColor="default" picture="">
    Test
  </PictureButton>,
);
